...
class MvtstkService extends __BaseService {
  static readonly correctionStockNegPath = '/gestionCommande/v1/mvtstk/correctionneg';
  static readonly correctionStockPosPath = '/gestionCommande/v1/mvtstk/correctionpos';
  static readonly entreeStockPath = '/gestionCommande/v1/mvtstk/entree';
  static readonly mvtStkArticlePath = '/gestionCommande/v1/mvtstk/filter/article/{idArticle}';
  static readonly sortieStockPath = '/gestionCommande/v1/mvtstk/sortie';
  static readonly stockReelArticlePath = '/gestionCommande/v1/mvtstk/stockreel/{idArticle}';
  ...
  correctionStockNegResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestionCommande/v1/mvtstk/correctionneg`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  correctionStockPosResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestionCommande/v1/mvtstk/correctionpos`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  entreeStockResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestionCommande/v1/mvtstk/entree`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  mvtStkArticleResponse(idArticle: number): __Observable<__StrictHttpResponse<Array<MvtStkDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestionCommande/v1/mvtstk/filter/article/${idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  sortieStockResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestionCommande/v1/mvtstk/sortie`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  stockReelArticleResponse(idArticle: number): __Observable<__StrictHttpResponse<number>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestionCommande/v1/mvtstk/stockreel/${idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
